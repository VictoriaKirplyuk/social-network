...
import { ProfileAttitude, RequestStatus, RouteNames } from '../../../enums';
  ...
  return (
    <div className={pS.pageContent}>
      <div className={gS.block}>
        {!isLoading ? users.map(u => <UserCard key={u.username} info={u} changeFriendStatus={changeFriendStatus} />) : <Preloader />}
      </div>
    </div>
  );
};
