...
export const requestFriend = createAsyncThunk('friends/requestFriend', async (username: string, thunkAPI) => {
  try {
...
export const revokeRequestFriend = createAsyncThunk(
  'friends/revokeRequestFriend',
...
export const getFriendIncoming = createAsyncThunk(
  'friends/getFriendIncoming',
  async (params: { page?: number; size?: number }, thunkAPI) => {
    thunkAPI.dispatch(changeStatus({ status: RequestStatus.LOADING }));
...
export const getFriendOutgoing = createAsyncThunk(
  'friends/getFriendOutgoing',
  async (params: { page?: number; size?: number }, thunkAPI) => {
    thunkAPI.dispatch(changeStatus({ status: RequestStatus.LOADING }));
